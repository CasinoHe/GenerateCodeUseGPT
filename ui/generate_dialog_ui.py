...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.labelSystemInfo = QtWidgets.QLabel(parent=self.groupBox_Prompt)
        self.labelSystemInfo.setObjectName("labelSystemInfo")
        self.horizontalLayout_16.addWidget(self.labelSystemInfo)
        self.lineEditSystem = QtWidgets.QLineEdit(parent=self.groupBox_Prompt)
        self.lineEditSystem.setObjectName("lineEditSystem")
        self.horizontalLayout_16.addWidget(self.lineEditSystem)
        ...
        self.verticalLayout_6.addWidget(self.plainTextEditPrompt)
        ...
        self.groupBoxEstimate = QtWidgets.QGroupBox(parent=Dialog)
        self.groupBoxEstimate.setObjectName("groupBoxEstimate")
        self.horizontalLayout_17 = QtWidgets.QHBoxLayout(self.groupBoxEstimate)
        self.horizontalLayout_17.setObjectName("horizontalLayout_17")
        self.verticalLayout_7 = QtWidgets.QVBoxLayout()
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.horizontalLayout_18 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_18.setObjectName("horizontalLayout_18")
        self.labelEstimateToken = QtWidgets.QLabel(parent=self.groupBoxEstimate)
        self.labelEstimateToken.setObjectName("labelEstimateToken")
        self.horizontalLayout_18.addWidget(self.labelEstimateToken)
        self.lineEditTokenAmount = QtWidgets.QLineEdit(parent=self.groupBoxEstimate)
        self.lineEditTokenAmount.setReadOnly(True)
        self.lineEditTokenAmount.setObjectName("lineEditTokenAmount")
        self.horizontalLayout_18.addWidget(self.lineEditTokenAmount)
        self.verticalLayout_7.addLayout(self.horizontalLayout_18)
        self.horizontalLayout_20 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_20.setObjectName("horizontalLayout_20")
        self.labelEstimateCost = QtWidgets.QLabel(parent=self.groupBoxEstimate)
        self.labelEstimateCost.setObjectName("labelEstimateCost")
        self.horizontalLayout_20.addWidget(self.labelEstimateCost)
        self.lineEditEstimateCost = QtWidgets.QLineEdit(parent=self.groupBoxEstimate)
        self.lineEditEstimateCost.setReadOnly(True)
        self.lineEditEstimateCost.setObjectName("lineEditEstimateCost")
        self.horizontalLayout_20.addWidget(self.lineEditEstimateCost)
        self.verticalLayout_7.addLayout(self.horizontalLayout_20)
        self.horizontalLayout_17.addLayout(self.verticalLayout_7)
        self.verticalLayout.addWidget(self.groupBoxEstimate)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.labelSystemInfo.setText(_translate("Dialog", "System info:"))
        ...
        self.groupBoxEstimate.setTitle(_translate("Dialog", "Estimate"))
        self.labelEstimateToken.setText(_translate("Dialog", "Estimate token amount: "))
