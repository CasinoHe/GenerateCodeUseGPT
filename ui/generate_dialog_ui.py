...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1258, 868))
        ...
        self.labelRealCost = QtWidgets.QLabel(parent=self.groupBoxOutPut)
        self.labelRealCost.setObjectName("labelRealCost")
        self.horizontalLayout_21.addWidget(self.labelRealCost)
        self.lineEdit = QtWidgets.QLineEdit(parent=self.groupBoxOutPut)
        self.lineEdit.setObjectName("lineEdit")
        self.horizontalLayout_21.addWidget(self.lineEdit)
        self.label_3 = QtWidgets.QLabel(parent=self.groupBoxOutPut)
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_21.addWidget(self.label_3)
        self.lineEditTotalCost = QtWidgets.QLineEdit(parent=self.groupBoxOutPut)
        self.lineEditTotalCost.setObjectName("lineEditTotalCost")
        self.horizontalLayout_21.addWidget(self.lineEditTotalCost)
        self.label_2 = QtWidgets.QLabel(parent=self.groupBoxOutPut)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_21.addWidget(self.label_2)
        self.lineEditHistoricalCost = QtWidgets.QLineEdit(parent=self.groupBoxOutPut)
        self.lineEditHistoricalCost.setObjectName("lineEditHistoricalCost")
        ...
        self.comboBoxSupplyName = QtWidgets.QComboBox(parent=self.groupBoxResult)
        self.comboBoxSupplyName.setObjectName("comboBoxSupplyName")
        ...
        self.label = QtWidgets.QLabel(parent=self.groupBoxResult)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.labelRealCost.setText(_translate("Dialog", "Real cost: "))
        self.label_3.setText(_translate("Dialog", "Total cost: "))
        self.label_2.setText(_translate("Dialog", "Historical cost: "))
