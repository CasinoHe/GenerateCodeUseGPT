...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEditResultJsonDir = QtWidgets.QLineEdit(parent=Dialog)
        self.lineEditResultJsonDir.setObjectName("lineEditResultJsonDir")
        self.horizontalLayout_5.addWidget(self.lineEditResultJsonDir)
        self.pushButtonOpenResultJsonDir = QtWidgets.QPushButton(parent=Dialog)
        self.pushButtonOpenResultJsonDir.setObjectName("pushButtonOpenResultJsonDir")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_4.setText(_translate("Dialog", "Result Json Dir: "))
        self.pushButtonOpenResultJsonDir.setText(_translate("Dialog", "Open Folder..."))
